...
-- =============================================================================
INSERT INTO products (id, team_id, name, sku, brand, category, base_price, cost_price, is_active) VALUES
  ('p1000000-0000-0000-0000-000000000001', 't1000000-0000-0000-0000-000000000001',
   '하이드레이팅 토너', 'BK-TN-001', '글로우랩', '스킨케어', 28000, 8000, true),
  ('p1000000-0000-0000-0000-000000000002', 't1000000-0000-0000-0000-000000000001',
   '비타민C 세럼', 'BK-SR-001', '글로우랩', '스킨케어', 45000, 12000, true),
  ('p1000000-0000-0000-0000-000000000003', 't1000000-0000-0000-0000-000000000001',
   '수분 크림', 'BK-CR-001', '글로우랩', '스킨케어', 38000, 10000, true),
  ('p1000000-0000-0000-0000-000000000004', 't1000000-0000-0000-0000-000000000001',
   '선크림 SPF50+', 'BK-SN-001', '글로우랩', '선케어', 32000, 9000, true),
  ('p1000000-0000-0000-0000-000000000005', 't1000000-0000-0000-0000-000000000001',
   '클렌징 폼', 'BK-CL-001', '글로우랩', '클렌저', 18000, 5000, true),
  ('p1000000-0000-0000-0000-000000000006', 't1000000-0000-0000-0000-000000000001',
   '립틴트 로즈', 'BK-LT-001', '컬러팝', '메이크업', 15000, 4000, true),
  ('p1000000-0000-0000-0000-000000000007', 't1000000-0000-0000-0000-000000000001',
   '아이라이너', 'BK-EL-001', '컬러팝', '메이크업', 12000, 3000, true),
  ('p1000000-0000-0000-0000-000000000008', 't1000000-0000-0000-0000-000000000001',
   '마스카라', 'BK-MC-001', '컬러팝', '메이크업', 18000, 5000, true)
ON CONFLICT DO NOTHING;

-- =============================================================================
-- 4. PRODUCT CHANNEL PRICES (channel-specific pricing for products)
-- =============================================================================
-- Skincare products on 올리브영, 쿠팡, 네이버 (3 channels each)
INSERT INTO product_channel_prices (product_id, channel_id, selling_price, channel_fee_rate, is_active) VALUES
  -- 하이드레이팅 토너 (base: 28,000)
  ('p1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000001', 28000, 35.00, true),  -- 올리브영
  ('p1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000002', 25200, 30.00, true),  -- 쿠팡 (~90%)
  ('p1000000-0000-0000-0000-000000000001', 'c1000000-0000-0000-0000-000000000003', 26600, 15.00, true),  -- 네이버 (~95%)

  -- 비타민C 세럼 (base: 45,000)
  ('p1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000001', 45000, 35.00, true),  -- 올리브영
  ('p1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000002', 40500, 30.00, true),  -- 쿠팡 (~90%)
  ('p1000000-0000-0000-0000-000000000002', 'c1000000-0000-0000-0000-000000000003', 42750, 15.00, true),  -- 네이버 (~95%)

  -- 수분 크림 (base: 38,000)
  ('p1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000001', 38000, 35.00, true),  -- 올리브영
  ('p1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000002', 34200, 30.00, true),  -- 쿠팡 (~90%)
  ('p1000000-0000-0000-0000-000000000003', 'c1000000-0000-0000-0000-000000000003', 36100, 15.00, true),  -- 네이버 (~95%)

  -- 선크림 SPF50+ (base: 32,000)
  ('p1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000001', 32000, 35.00, true),  -- 올리브영
  ('p1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000002', 28800, 30.00, true),  -- 쿠팡 (~90%)
  ('p1000000-0000-0000-0000-000000000004', 'c1000000-0000-0000-0000-000000000003', 30400, 15.00, true),  -- 네이버 (~95%)

  -- 클렌징 폼 (base: 18,000)
  ('p1000000-0000-0000-0000-000000000005', 'c1000000-0000-0000-0000-000000000001', 18000, 35.00, true),  -- 올리브영
  ('p1000000-0000-0000-0000-000000000005', 'c1000000-0000-0000-0000-000000000002', 16200, 30.00, true),  -- 쿠팡 (~90%)
  ('p1000000-0000-0000-0000-000000000005', 'c1000000-0000-0000-0000-000000000003', 17100, 15.00, true),  -- 네이버 (~95%)

  -- Makeup products on 올리브영, 무신사 (2 channels each)
  -- 립틴트 로즈 (base: 15,000)
  ('p1000000-0000-0000-0000-000000000006', 'c1000000-0000-0000-0000-000000000001', 15000, 35.00, true),  -- 올리브영
  ('p1000000-0000-0000-0000-000000000006', 'c1000000-0000-0000-0000-000000000005', 14000, 25.00, true),  -- 무신사

  -- 아이라이너 (base: 12,000)
  ('p1000000-0000-0000-0000-000000000007', 'c1000000-0000-0000-0000-000000000001', 12000, 35.00, true),  -- 올리브영
  ('p1000000-0000-0000-0000-000000000007', 'c1000000-0000-0000-0000-000000000005', 11000, 25.00, true),  -- 무신사

  -- 마스카라 (base: 18,000)
  ('p1000000-0000-0000-0000-000000000008', 'c1000000-0000-0000-0000-000000000001', 18000, 35.00, true),  -- 올리브영
  ('p1000000-0000-0000-0000-000000000008', 'c1000000-0000-0000-0000-000000000005', 16500, 25.00, true)   -- 무신사
ON CONFLICT DO NOTHING;

-- =============================================================================
-- 5. PROMO TEMPLATES (reusable promotion patterns)
-- =============================================================================
...
-- =============================================================================
-- 6. SAMPLE PROMOTIONS (for calendar demo)
...
-- =============================================================================
-- 7. PROMO-PRODUCTS (link products to promotions)
-- =============================================================================
